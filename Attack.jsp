...
<div id="templatemo_menu_wrapper">    
    <div id="templatemo_menu">
        <ul>
            ...
            <li><a href="O_HomePage.html"><span></span>Author</a></li>
            <li><a href="E_HomePage.html"><span></span>Reader</a></li>
			        <li><a href="T_HomePage.html"><span></span>TTP</a></li>
                    <li><a href="D_HomePage.html"><span></span>Domain Manager </a></li>
                    <li><a href="C_HomePage.html"><span></span>Cloud Server</a></li>
            <li></li>
        </ul>    	
    </div> 
    <!-- end of menu --></div> 
...
<div class="news_section">
  <p>MAIN MENU </p>
  <p><a href="index.html" class="current">Home</a></p>
  <p><a href="O_HomePage.html">Author</a></p>
              <p>  <a href="E_HomePage.html">Reader</a></p>
              <p><a href="T_HomePage.html">TTP </a></p>
              <p><a href="O_HomePage.html">Domain Manager </a></p>
              <p><a href="C_HomePage.html">Cloud Server</a></p>
      ...
      <div class="content_right_section">
        <div class="content_header_02">
			 <h2 style="text-align:center">Attack Block File Content </h2>
				<p>&nbsp;</p>
				<h2><a href="Attack.jsp">Back</a></h2>
               <iframe src="Attack1.jsp" width="780" height="500"></iframe>
		   <p>&nbsp;</p>
            </div>
