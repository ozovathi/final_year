  ...
  <p><a href="T_ViewMetaData.jsp">View Meta Data</a></p>
    ...
    <marqueue>  <h1>A Searchable and Verifiable Data Protection Scheme for Scholarly Big Data. </h1></marqueue>
      <div class="content_right_section">
        <div class="content_header_02"><h2>&nbsp;</h2>
				<h2 style="text-align:center">Send Verification Details to Author:</h2>
	
				<a href="T_MainPage.jsp">Back</a>
               <iframe src="sendver.jsp" width="780" height="300"></iframe>
          <p>&nbsp;</p>
        </div>
