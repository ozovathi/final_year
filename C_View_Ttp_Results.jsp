...
<title>C_View_Ttp_Results </title>
...
<div id="templatemo_menu_wrapper">    
    <div id="templatemo_menu">
        <ul>
            <li> <a href="C_HomePage.html" ><span></span>Home</a></li>
            ...
            <li><a href="#"><span></span>Reader</a></li>
                    ...
                    <li><a href="C_MainPage.jsp" class="current"><span></span>Cloud Server</a></li>
            <li></li>
        </ul>    	
    </div> 
    <!-- end of menu --></div> 
...
<div class="news_section">
  <p>MAIN MENU </p>
  <p><a href="C_HomePage.html" class="current">Home</a></p>
  <p><a href="index.html">Logout</a></p>
    ...
    <marqueue>  <h1>View Throughput Results in ms </h1>
    </marqueue>
      <div class="content_right_section">
            <div class="content_header_02">
              <span style="color:#6e6e6e;    line-height: 1.5em; "><p>&nbsp;</p>
              <p>
                <iframe width="600" height="350" src="Results3.jsp"></iframe>
              </p>
              </span>
              <p><a href="C_MainPage.jsp">Back</a></p>
            </div>
