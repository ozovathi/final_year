  ...
  <p><a href="D_AddDomain.jsp">Add Domains</a></p>
    ...
    <marqueue>  <h1>A Searchable and Verifiable Data Protection Scheme for Scholarly Big Data. </h1></marqueue>
      <div class="content_right_section">
			...
			<h2 style="text-align:center">Add Domain:</h2>
	
				<a href="D_AddDomain.jsp">Back</a>
			
              <iframe src="adddomain.jsp" width="780" height="300"></iframe>
              <p> Project Details </p>
            </div>
...
<span class="style1"><!-- end of content -->
