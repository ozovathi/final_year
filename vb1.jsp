...
String oname=(String)application.getAttribute("oname");
	String query="select * from pusg_cloudserver where  ownername='"+oname+"' "; 
	...
	<tr><td>File Name</td><td>Owner Name</td><td>MAC-1</td><td>MAC-2</td><td>MAC-3</td><td>MAC-4</td><td>SK</td></tr>
	<%	
