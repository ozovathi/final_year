...
%>
     <div class="clr"></div>
          ...
          <form method="post" action="O_UpdateBlock3.jsp" >
<table width="780" border="1" align="center">

	<tr>
		<td width="286" bgcolor="#00FF00"><span class="style1 style4"><strong>File Name :- </strong></span></td>
		<td width="356"><input name="file" type="text" id="t42" size="50"
			value="<%= file %>" readonly="readonly" /></td>
	</tr>
	<tr>
		<td width="286" bgcolor="#00FF00"><span class="style1 style4"><strong>Block</strong></span></td>
		<td width="286"><span class="style4"><input name="block" type="text" id="t42" size="40"
	...
	<tr>
		<td bgcolor="#00FF00"><span class="style1"><strong>MAC: </strong></span></td>
