...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from pusg_owner  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into pusg_owner(name,pass,email,mobile,addr,dob,gender,pin,location,imagess) values(?,?,?,?,?,?,?,?,?,?)");
