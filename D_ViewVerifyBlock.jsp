...
<div id="templatemo_menu_wrapper">    
    <div id="templatemo_menu">
        <ul>
            <li> <a href="D_HomePage.html" ><span></span>Home</a></li>
            <li><a href="#"><span></span>Author</a></li>
            <li><a href="#"><span></span>Reader</a></li>
			        <li><a href="#"><span></span>TTP</a></li>
                    <li><a href="D_MainPage.jsp" class="current"><span></span>Domain Manager </a></li>
...
<div class="news_section">
  <p>MAIN MENU </p>
  <p><a href="D_HomePage.html" class="current">Home</a></p>
  <p><a href="D_AddDomain.jsp">Add Domains</a></p>
              <p>  <a href="D_ViewDomain.jsp">View All Domains</a></p>
              <p><a href="D_ViewVerifyBlock.jsp">View verified Blocks</a></p>
    ...
    <marqueue>  <h1>A Searchable and Verifiable Data Protection Scheme for Scholarly Big Data. </h1></marqueue>
      <div class="content_right_section">
			...
			<h2 style="text-align:center">View Verified Blocks Based on Domain:</h2>
			 <iframe src="vblock.jsp" width="680" height="300"></iframe>
			<p style="text-align:center">&nbsp;</p>
			<p style="text-align:center">&nbsp;</p>
			<p style="text-align:center">&nbsp;</p>
			<a href="D_MainPage.jsp">Back</a>
...
</span><div class="cleaner"><span class="style1">&nbsp;</span>
