    ...
    <marqueue>  <h1>A Searchable and Verifiable Data Protection Scheme for Scholarly Big Data. </h1></marqueue>
      <div class="content_right_section">
        <div class="content_header_02">  <p style="font-size:24px; color:#CC6600;">&nbsp;</p>
              ...
              <div class="clr"></div>
          <form id="form1" name="form1" method="post" action="E_RequestFile1.jsp">
<table width="780" border="1" align="center">

	<tr>
		<td class="style4">Enter File Name :-</td>
		<td><input required="required" name="fr" type="text" id="t42"
			 /></td>
	</tr>
	<tr>
		<td colspan="2">&nbsp;</td>
