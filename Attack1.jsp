...
<tr><td align="center" bgcolor="#FF0000"><span class="style4">User Name</span></td>
<td><input type="text" placeholder="Enter Your Name" name="aname"/> </td></tr>
<tr><td align="center" bgcolor="#FF0000"><span class="style4">File Name</span></td>
<td><input type="text" placeholder="Enter File Name to Attack" name="fname"/> </td></tr>
<tr><td align="center" bgcolor="#FF0000"><span class="style4">Select Block</span></td>
...
<tr><td align="center" bgcolor="#FF0000"><span class="style4">Owner Name</span></td>
<td><input type="text" placeholder="Enter Owner Name" name="owner"/> </td></tr>
<tr> <td align="center" bgcolor="#FF0000"><span class="style4">Select the Domain</span></td>
<td><select name="domain" ><option>
--Select--</option>
<%
