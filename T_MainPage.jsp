...
<div id="templatemo_menu_wrapper">    
    <div id="templatemo_menu">
        <ul>
            <li> <a href="T_HomePage.html" ><span></span>Home</a></li>
            <li><a href="#"><span></span>Author</a></li>
            <li><a href="#"><span></span>Reader</a></li>
			        <li><a href="T_MainPage.jsp" class="current"><span></span>TTP</a></li>
...
<div class="news_section">
  <p>MAIN MENU </p>
  <p><a href="T_HomePage.html" class="current">Home</a></p>
  <p><a href="T_ViewMetaData.jsp">View Meta Data</a></p>
              <p>  <a href="T_VerifyBlock.jsp">Verify All Blocks</a></p>
              <p><a href="T_SendVerifyBlock.jsp">Send Block Verification</a></p>
    ...
    <marqueue>  <h1>Welcome to Trusted Third Party !!! </h1>
    </marqueue>
      <div class="content_right_section">
            <div class="content_header_02"><span style="color:#6e6e6e;    line-height: 1.5em; ">
            <p><img src="images/TTP.png" width="477" height="267" /></p>
              </span></div>
