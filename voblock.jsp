...
ResultSet rs=connection.createStatement().executeQuery("select * from pusg_ttpverified where name='"+name+"'");
ResultSet rs2=connection.createStatement().executeQuery("select * from pusg_ttpverified where name='"+name+"'");
