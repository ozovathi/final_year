...
ResultSet rs=connection.createStatement().executeQuery("select * from pusg_owner ");
%><%
while(rs.next())
{
...
<tr><td rowspan="7"><img src="images1.jsp?id=<%=rs.getInt(1)%>" alt=""/></td> <td align="center">Owner Name:</td><td align="center"><%=rs.getString(2)%></td></tr>
